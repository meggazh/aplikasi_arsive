...
<body>
  <div class="navbar navbar-inverse" role="navigation">
        ...
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="sub open">
            ...
            <ul class="templatemo-submenu">
              ...
              <li  class="active"><a href="setup_barang.php">Setup Barang</a></li>              
            </ul>
          </li>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    ...
                    <table id="dg"
                          ...
                          url="server/service_barang.php?method=list"
                          toolbar="#toolbar" 
                          pagination="true"
                          rownumbers="true"
                          fitColumns="true"
                      ...
                      <thead>
                        <tr>
                          ...
                          <th field="kode_barang" width="30">Kode Barang</th>
                          <th field="nama_barang" width="80">Nama</th>
                          <th field="chasis" width="30">Chasis</th>
                          <th field="type" width="30">Type</th>
                          <th field="spec" width="30">Spec</th>
                          <th field="qty" width="10">Qty</th>
                          <th field="harga" width="30">Price</th>
                          <th field="rack" width="30">Rack</th>
                        </tr>
                      </thead>
                    </table>
                    <div id="toolbar">
                      <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-add" plain="true" onclick="newR()">New Barang</a>
                      <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-edit" plain="true" onclick="editR()">Edit Barang</a>
                      <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-remove" plain="true" onclick="destroyR()">Remove Barang</a>
                    </div>
                    <div id="dlg" 
                      class="easyui-dialog" 
                      style="width:400px;height:280px;padding:10px 20px"
                      closed="true" buttons="#dlg-buttons">
                    <div class="ftitle">Barang Information</div>
                    <form id="fm" method="post" novalidate>
                    
                      <div class="fitem">
                        <label>Kode barang:</label>
                        <input name="kode_barang" class="easyui-textbox" required="true">
                      </div>
                      <div class="fitem">
                      ...
                      <div class="fitem">
                        ...
                        <select name="rack_id" class="easyui-combobox">
                          <?php 
                            include "server/koneksi.php";
                            //error_reporting(1);
                            
                            
                            $sql = mysql_query("select * from rack");
                            while($rack = mysql_fetch_object($sql)){
                             
                                echo "<option value='".$rack->id."'>".$rack->baris."-".$rack->kolom."</option>";
    ...
    function newR(){
      ...
      $('#fm').form('clear');
      url = 'server/service_barang.php?method=save';
    }
    function editR(){
      ...
      if (row){
        ...
        $('#fm').form('load',row);
        url = 'server/service_barang.php?method=update&id='+row.id;
      }
    }
    function saveR(){
      $('#fm').form('submit',{
  ...
  function destroyR(){
    ...
    if (row){
      $.messager.confirm('Confirm','Are you sure you want to destroy this Rack  ?',function(r){
        if (r){
          $.post('server/service_barang.php?method=destroy',{id:row.id},function(result){
            if (result.success){
              $('#dg').datagrid('reload'); // reload the user data
            } else {
